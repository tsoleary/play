...
- [`readr`](https://tsoleary.github.io/comp_bio/CheatSheets/readr.pdf) -- **import your data**. Need to import data? Noobs = `read.csv()`. Cool kids = `read_csv()`. ^[Ever had a column that is actually a integer import into R as a character? `readr` can easily define column types as you import, among other things.]
...
- [`ggplot2`](https://tsoleary.github.io/comp_bio/CheatSheets/ggplot2.pdf) -- **plot your data** -- everyone uses ggplot.
- [`stringr`](https://tsoleary.github.io/comp_bio/CheatSheets/stringr.pdf) -- **maipulate strings**. Have a bunch of strings for some fucking reason? Use `stringr`. 
